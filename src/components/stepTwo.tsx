...
import { Button, Card, Elevation, Switch, Alignment } from "@blueprintjs/core";
import "./stepTwo.css";
const StepTwo: FC = (): ReactElement => {
  return (
    <>
      ...
      <Switch label="Monthly" alignIndicator={Alignment.RIGHT}></Switch>
