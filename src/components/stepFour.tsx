...
const StepFour: FC = (): ReactElement => {
  return (
    <>
      <h1>Finishing up</h1>
      <p>Double-check everything looks OK before confirming</p>
      <Menu>
        <MenuItem text="Arcade (Monthly) $9/mo" disabled />
        <MenuItem text="Online Service +$1/mo" disabled />
        <MenuItem text="Large Stprage +2/mo" disabled />
        <MenuDivider />
        <MenuItem text="Total (per month) +12/mo" disabled />
      </Menu>
      ...
      <p>
        ...
        platform.If you ever need support.please feel free to email us to
